...
from training_loop import train_model_with_knn_PUPO
...
file_name = args.data_path + 'ckpt/' + args.problem + '/train/logs' + '/' + time_stamp + "-n{}".format(
    args.nb_nodes) + "-gpu{}".format(args.gpu_id) + ".txt"
...
train_model_with_knn_PUPO(args, model_train, model_baseline, optimizer_model, scheduler_model, device, file, time_stamp)
